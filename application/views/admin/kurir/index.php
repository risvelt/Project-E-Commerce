              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-header">
                    <h4>Data Kurir</h4> <a href="<?php echo site_url('kurir/add'); ?>" class="btn btn-primary">
                      Tambah Kurir
                    </a>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                            ...
                            <a href="<?php echo site_url('kurir/hapus/'.$item->idKurir) ;?>" class="btn btn-danger">Hapus</a></td>
                        </tr>
                          <?php  } ?>

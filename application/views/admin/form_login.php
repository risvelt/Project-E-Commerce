...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/node_modules/bootstrap-social/bootstrap-social.css'); ?>">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="mt-5 text-muted text-center">
              Don't have an account? <a href="<?php echo site_url('register/index'); ?>">Create One</a>
            </div>

              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-header">
                    <h4>Data Kota</h4> <a href="<?php echo site_url('kota/add'); ?>" class="btn btn-primary">
                      Tambah Kota
                    </a>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                            ...
                            <a href="<?php echo site_url('kota/hapus/'.$item->idKota) ;?>" class="btn btn-danger">Hapus</a></td>
                        </tr>
                          <?php  } ?>

        ...
        <section class="section">
          <div class="section-header">
            <div class="section-header-back">
              <a href="<?php echo site_url('dashboard/toko'); ?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
          ...
          <div class="section-body">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
			  <form id="setting-form" method="post" enctype="multipart/form-data" action="<?php echo site_url('Toko/tambahToko');?>">

	...
	<div id="app">
		<div class="main-wrapper container">
			...
			<nav class="navbar navbar-expand-lg main-navbar">
				...
				<a href="<?php echo site_url('dashboard/index'); ?>" class="btn btn-outline-light">Menu Member</a>
				&nbsp; &nbsp; &nbsp;
        		<a href="<?php echo site_url('member/logout'); ?>" class="btn btn-outline-light">Logout</a>
				<?php }else{ ?>
				<a href="<?php echo site_url('Member/indexmember')?>" class="btn btn-outline-light">Masuk</a>
				&nbsp; &nbsp; &nbsp;
				<a href="<?php echo site_url('register/index')?>" class="btn btn-outline-light">Daftar</a>
				<?php } ?>
      </nav>

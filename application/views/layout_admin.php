...
<html lang="en">
  <head>
    ...
    <meta
      ...
      name="viewport"
    />
    <title>Ecommerce Dashboard &mdash; TOKOKITA</title>
    ...
    <link
      ...
      crossorigin="anonymous"
    />
    <script src="https://kit.fontawesome.com/d518c89b75.js" crossorigin="anonymous"></script>

    <!-- CSS Libraries -->
    <link rel="stylesheet" href="../node_modules/jqvmap/dist/jqvmap.min.css" />
    <link
      rel="stylesheet"
      href="../node_modules/summernote/dist/summernote-bs4.css"
    />
    <link
      rel="stylesheet"
      ...
      <div class="main-wrapper">
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo site_url('adminpanel/dashboard');?>">TOKOKITA</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo site_url('adminpanel/dashboard');?>">St</a>
          </div>
          <ul class="sidebar-menu">
            <li><a class="nav-link" href="<?php echo site_url('adminpanel/dashboard');?>"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
            <li><a class="nav-link" href="<?php echo site_url('kategori');?>"><i class="fas fa-th"></i> <span>Kategori</span></a></li>
              <li class="nav-item dropdown active">
                <a href="#" class="nav-link has-dropdown"
                  ><i class="fa-solid fa-plane"></i><span>Jasa Pengiriman</span></a
                >
                <ul class="dropdown-menu">
                  <li>
                    <a class="nav-link" href="<?php echo site_url('kota');?>"
                      >Kota</a
                    >
                  </li>
                  <li class="active">
                   ...
                   <li class="active">
                    <a class="nav-link" href="<?php echo site_url('ongkir');?>"
                      >Ongkos Kirim</a
                    >
                  </li>
                </ul>
              </li>
              <li><a class="nav-link" href="<?php echo site_url('member');?>"><i class="fa-solid fa-users"></i> <span>Kelola Member</span></a>
              </li>
              <li><a class="nav-link" href="<?php echo site_url('toko');?>"><i class="fa-solid fa-store"></i> <span>Kelola Toko</span></a>
              </li>
          </ul>
        </aside>
      </div>
